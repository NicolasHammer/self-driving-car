...
def main(file_name, starting_value):
    ...
    while True:
        ...
        if not paused:
            ...
            # last_time = time.time()
            # maybe resize to smaller image
            gta_screen = cv2.resize(gta_screen, (160, 120))
            ...
            textPrint.tprint(
                screen, "Axis {} value: {:>6.3f}".format(0, axis_0))
            ...
            textPrint.tprint(
                screen, "Axis {} value: {:>6.3f}".format(0, axis_3))
